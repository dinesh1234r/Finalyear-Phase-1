...
function Patients() {
  ...
  const handlesumbit=async()=>{
    const response=await axios.post('https://finalyear-phase-1-backend.onrender.com/patient/login',{Aadhar:username,password:password})
  ...
  const handleSubmitDrawer=async()=>{
    ...
    const response=await axios.post('https://finalyear-phase-1-backend.onrender.com/patient/register',{
      Name:name,
      Address:address,
      Aadhar:aadhar,
      Phone_no:phone,
