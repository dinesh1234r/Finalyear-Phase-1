...
function AddNurse() {
  ...
  const handlesubmit=async()=>{
    ...
    {
      console.log(DOB);
    const response=await axios.post('https://finalyear-phase-1-backend.onrender.com/admin/postbyadminfornurse',{Admin,gender,Doctor_name,DOB,photo,Email_Address,Current_Address,Qualifications,Specialization,Medical_License_Number,Medical_Council_Registration_Number,Years_of_experience},{
      headers:{
